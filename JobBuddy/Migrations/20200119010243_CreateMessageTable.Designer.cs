...
namespace JobBuddy.Migrations
{
    ...
    [Migration("20200119010243_CreateMessageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobBuddy.Models.ChatRoom.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JobBuddy.Models.ChatRoom.Message", b =>
                {
                    b.HasOne("JobBuddy.Models.ApplicationUser", "User")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("JobBuddy.Models.JobCategory", b =>
                {
                    b.HasOne("JobBuddy.Models.Company", null)
                        .WithMany("JobCategories1")
                        .HasForeignKey("CompanyId");
                });
